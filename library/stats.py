...
class Gpu:
    ...
    def stats(cls):
        ...
        display_themed_value(
            ...
            value=round(memory_used_mb / 1024, 1),
            min_size=5,
            unit=" G"
        )
        ...
        display_themed_value(
            ...
            value=round(total_memory_mb / 1024, 1),
            min_size=5,
            unit=" G"
        )
...
class Memory:
    ...
    def stats(cls):
        ...
        display_themed_value(
            ...
            value=round(sensors.Memory.virtual_used() / (1024 ** 3), 1),
            min_size=5,
            unit=" G"
        )
        display_themed_value(
            theme_data=memory_stats_theme_data['VIRTUAL']['FREE'],
            value=round(sensors.Memory.virtual_free() / (1024 ** 3), 1),
            min_size=5,
            unit=" G"
        )
        display_themed_value(
            theme_data=memory_stats_theme_data['VIRTUAL']['TOTAL'],
            value=round((sensors.Memory.virtual_free() + sensors.Memory.virtual_used()) / (1024 ** 3), 1),
            min_size=5,
            unit=" G"
        )
